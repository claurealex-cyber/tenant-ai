...
const mainNavItems = [
  ...
  { label: "Applications", href: "/applications", icon: "clipboard" },
...
const adminNavItems = [
  ...
  { label: "Subscriptions", href: "/admin/subscriptions", icon: "tag" },
  { label: "Pricing", href: "/admin/pricing", icon: "layers" },
  { label: "Usage", href: "/admin/usage", icon: "bar-chart" },
  ...
  { label: "Chicago Listings", href: "/admin/chicago-listings", icon: "grid" },
...
function NavIcon({ icon, className }: { icon: string; className?: string }) {
  ...
  switch (icon) {
    ...
    case "layers":
      return (
        <svg className={cls} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L12 12.75 6.43 9.75m11.14 0l4.179 2.25-9.75 5.25-9.75-5.25 4.179-2.25" />
        </svg>
      );
    case "bar-chart":
      return (
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-slate-900">
        ...
        <div className="flex h-16 items-center gap-2 px-6">
          ...
          <span className="text-lg font-semibold text-white">Tenant AI</span>
        </div>
